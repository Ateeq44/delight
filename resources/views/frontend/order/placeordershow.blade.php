        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-color text-center text-white ">
                    <P class="" style=" font-size:20px; font-weight: 700;">Order Complete - Thank you for your order</P>
                    <P class="" style=" font-size:20px; font-weight: 700;">Your Order Submitted Successfully!</P>
                </div>
                <div class="card-body">
                    <div class="row" style="font-size: 15px;">
                        <div class="col-md-5 orderdetails">
                            ...
                            <div class="border px-3 py-2">{{$order->tracking_no}}</div>
                        ...
                        <div class="col-md-7">
                            ...
                            <h1 class="fa-2x mt-3 font-weight-bold"  style="color:#57b846">Grand Total: ${{$order->total_price}}</h1>
                        </div>
                    </div>
