                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="shipng">
                                    ...
                                    @if(@$payment)
                                    <button type="button" id="" class="btn div1 bg-color mr-4 text-white float-right" data-toggle="modal" data-target=".bd-example-modal-lg3" style="margin-left: 470px; display: none;">Change</button>
                                    @endif
                                </div><br>
                            ...
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input id="credit" name="paymentMethod" type="radio" onclick="show1();" class="custom-control-input cash" checked="" required="">
                                    <label class="custom-control-label" for="credit">Cash On Delivery</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input id="debit" name="paymentMethod" type="radio" onclick="show2();" class="custom-control-input card" required="">
                                    <label class="custom-control-label" for="debit" >Debit card | Credit card</label>
                                </div>
                            </div>
                            <hr>
                            @if(@$payment)
                            <div class="div11" id="div1" style="display:none;">
                            ...
                            @if(!@$payment)
                            <button type="button" class="btn div1 btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg1" style="margin-bottom: 20px; display: none;">Add Payment Methods</button>
                            @endif
            ...
            <div class="col-lg-4 col-md-6 order1">
                <div class="checkout__order">
                    <form action="{{url('place_order')}}" method="POST" class="require-validation"  data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_KEY') }}"  id="payment-form">
                        ...
                        <input type="hidden" name="total" value="{{@$total}}">
                        <button type="submit" class="site-btn ">PLACE ORDER payment</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    function show1(){
        ...
        // document.getElementsByClassName('order1')[0].style.display ='none';
    ...
    function show2(){
        ...
        // document.getElementsByClassName('order1')[0].style.display ='block';
    }
