                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" >
                            <div class="shipng">
                                ...
                                @if(@$payment)
                                <button type="button" id="" class="btn div1 bg-color mr-4 text-white float-right" data-toggle="modal" data-target=".bd-example-modal-lg3" style="margin-left: 470px;">Change</button>
                                @endif
                            </div><br>
